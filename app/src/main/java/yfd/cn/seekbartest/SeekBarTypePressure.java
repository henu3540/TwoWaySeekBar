 ...
 */
public class SeekBarTypePressure extends View{
    ...
    public SeekBarTypePressure(Context context) {
        this(context, null);
    }

    public SeekBarTypePressure(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SeekBarTypePressure(Context context, AttributeSet attrs, int defStyle) {
...
//        int height = measureHeight(heightMeasureSpec);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int temp_min = (int)progressLow * 7 / 100;
        int temp_max = (int)progressHigh * 7 / 100;
        String tv_min = "";
        String tv_max = "";
        if (temp_min == 0) {
            tv_min = "0";
...
//            Log.d("ACTION_UP", "------------------");
    ...
    public interface OnSeekBarChangeListener {
        ...
        //滑动时
        public void onProgressChanged(SeekBarTypePressure seekBar, double progressLow,
                                      double progressHigh);
